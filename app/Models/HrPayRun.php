...
class HrPayRun extends Model
{
    ...
    protected $guarded = [];
    protected $casts = ['period_from' => 'date', 'period_to' => 'date', 'pay_date' => 'date', 'paid_at' => 'date', 'gross_total' => 'decimal:6', 'deduction_total' => 'decimal:6', 'employer_contribution_total' => 'decimal:6', 'net_total' => 'decimal:6', 'overtime_multiplier' => 'decimal:4', 'approved_at' => 'datetime'];
