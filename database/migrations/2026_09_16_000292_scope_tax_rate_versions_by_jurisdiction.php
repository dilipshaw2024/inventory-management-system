...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('tax_rates', function (Blueprint $table): void {
            ...
            $table->unique(['company_id', 'code', 'jurisdiction', 'effective_from'], 'tax_rates_company_code_jurisdiction_from_unique');
        });
    }
    ...
    {
        Schema::table('tax_rates', function (Blueprint $table): void {
            $table->dropUnique('tax_rates_company_code_jurisdiction_from_unique');
