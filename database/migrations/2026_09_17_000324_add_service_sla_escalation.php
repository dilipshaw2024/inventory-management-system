...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('service_requests', function (Blueprint $table): void {
            $table->timestamp('sla_breached_at')->nullable()->after('response_due_at');
            ...
            $table->index(['company_id', 'status', 'response_due_at', 'last_sla_escalated_at'], 'service_request_sla_escalation_idx');
        });
    }
    ...
    {
        Schema::table('service_requests', function (Blueprint $table): void {
            $table->dropIndex('service_request_sla_escalation_idx');
