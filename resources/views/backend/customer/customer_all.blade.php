...
@section('admin')
 ...
 <div class="page-content">
   ...
   <a href="{{ route('customer.edit',$item->id) }}" class="btn btn-info sm" title="Edit Data">  <i class="fas fa-edit"></i> </a>
     ...
     <form method="POST" action="{{ route('customer.delete',$item->id) }}" class="d-inline" onsubmit="return confirm('Delete this customer?');"> @csrf <button type="submit" class="btn btn-danger sm" title="Delete Data"><i class="fas fa-trash-alt"></i></button> </form>
