...
@section('admin')
 ...
 <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <!-- end page title -->
    @php
    $payment = App\Models\Payment::where('invoice_id',$invoice->id)->firstOrNew(['invoice_id' => $invoice->id]);
    @endphp                    
    <div class="row">
        <div class="col-12">
            <div class="card">
...
<h4>Invoice No: #{{ $invoice->invoice_no }} - {{ date('d-m-Y',strtotime($invoice->date)) }} </h4>
     ...
     <table class="table table-dark" width="100%">
        <tbody>
            <tr>
                ...
                <td><p> Name: <strong> {{ data_get($payment, 'customer.name', 'N/A') }} </strong> </p></td>
                <td><p> Mobile: <strong> {{ data_get($payment, 'customer.mobile_no', 'N/A') }} </strong> </p></td>
               <td><p> Email: <strong> {{ data_get($payment, 'customer.email', 'N/A') }} </strong> </p></td>                
            </tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center" style="background-color: #8B008B">{{ data_get($details, 'product.quantity', 0) }}</td>
