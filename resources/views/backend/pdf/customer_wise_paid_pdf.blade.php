...
<div class="table-responsive">
    <table class="table">
      ...
      @php
        ...
        <td class="text-center"> {{ data_get($item, 'customer.name', 'N/A') }} </td> 
        <td class="text-center"> #{{ data_get($item, 'invoice.invoice_no', 'N/A') }}   </td> 
        <td class="text-center"> {{ data_get($item, 'invoice.date') ? date('d-m-Y',strtotime(data_get($item, 'invoice.date'))) : 'N/A' }} </td> 
