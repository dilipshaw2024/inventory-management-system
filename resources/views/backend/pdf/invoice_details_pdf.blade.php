    ...
    <div class="row">
        <div class="col-12">
            <div class="invoice-title">
                <h4 class="float-end font-size-16"><strong>Invoice No # {{ data_get($payment, 'invoice.invoice_no', 'N/A') }}</strong></h4>
                <h3>
                ...
                <div class="col-6 mt-4 text-end">
                    <address>
                        <strong>Invoice Date:</strong><br>
                         {{ data_get($payment, 'invoice.date') ? date('d-m-Y',strtotime(data_get($payment, 'invoice.date'))) : 'N/A' }} <br><br>
                    </address>
                </div>
            </div>
        </div>
...
<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            <td> {{ data_get($payment, 'customer.name', 'N/A') }}</td>
            <td class="text-center">{{ data_get($payment, 'customer.mobile_no', 'N/A') }}</td>
            <td class="text-center">{{ data_get($payment, 'customer.email', 'N/A') }}</td>
   ...
   $invoice_details = App\Models\InvoiceDetail::where('invoice_id',$payment->invoice_id)->get();     
        ...
        <tr>
           <td class="text-center">{{ $key+1 }}</td>
            <td class="text-center">{{ data_get($details, 'category.name', 'N/A') }}</td>
            <td class="text-center">{{ data_get($details, 'product.name', 'N/A') }}</td>
            <td class="text-center">{{ data_get($details, 'product.quantity', 0) }}</td>
