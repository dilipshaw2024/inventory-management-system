...
<div class="table-responsive">
    ...
    <h3 class="text-center"><strong>Supplier Name : </strong> {{ $allData->first()?->supplier?->name ?? 'No supplier record found' }} </h3>
    ...
    <table class="table">
        ...
        <tr>
         ...
         <td class="text-center"> {{ data_get($item, 'supplier.name', 'N/A') }} </td> 
         <td class="text-center"> {{ data_get($item, 'unit.name', 'N/A') }} </td> 
         <td class="text-center"> {{ data_get($item, 'category.name', 'N/A') }} </td> 
