 ...
 <div class="page-content">
    ...
    <a href="{{ route('purchase.add') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fas fa-plus-circle"> Add Purchase </i></a> <br>  <br>               
            ...
            <tr>
                ...
                <td> 
@if($item->status == '0')
<form method="POST" action="{{ route('purchase.delete',$item->id) }}" class="d-inline" onsubmit="return confirm('Delete this pending purchase?');"> @csrf <button type="submit" class="btn btn-danger sm" title="Delete Data"><i class="fas fa-trash-alt"></i></button> </form>
@endif
                </td>
