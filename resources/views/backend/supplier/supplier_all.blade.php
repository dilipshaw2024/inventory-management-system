...
@section('admin')
 ...
 <div class="page-content">
   ...
   <a href="{{ route('supplier.edit',$item->id) }}" class="btn btn-info sm" title="Edit Data">  <i class="fas fa-edit"></i> </a>
     ...
     <form method="POST" action="{{ route('supplier.delete',$item->id) }}" class="d-inline" onsubmit="return confirm('Delete this supplier?');"> @csrf <button type="submit" class="btn btn-danger sm" title="Delete Data"><i class="fas fa-trash-alt"></i></button> </form>
