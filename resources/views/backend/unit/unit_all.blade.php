...
@section('admin')
 ...
 <div class="page-content">
   ...
   <form method="POST" action="{{ route('unit.delete',$item->id) }}" class="d-inline" onsubmit="return confirm('Delete this unit?');"> @csrf <button type="submit" class="btn btn-danger sm" title="Delete Data"><i class="fas fa-trash-alt"></i></button> </form>
